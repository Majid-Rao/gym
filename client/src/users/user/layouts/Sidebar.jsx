...
const SIDEBAR_ITEMS = [
  { name: "Dashboard", icon: BarChart2, color: "#6366f1", href: "/userdashboard" },
  ...
  { name: "Feature 1", icon: ArrowLeftRight, color: "#10B981", href: "/usersuggestion" },
  { name: "ChatBot", icon: BookOpenCheck, color: "#F59E0B", href: "/chatbot" },
  { name: "Add Activities", icon: ArrowLeftRight, color: "#10B981", href: "/addactivities" },
  { name: "View Activities", icon: BookOpenCheck, color: "#F59E0B", href: "/viewactivities" },
